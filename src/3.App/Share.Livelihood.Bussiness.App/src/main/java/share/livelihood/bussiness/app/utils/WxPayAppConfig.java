...
public class WxPayAppConfig extends WXPayConfig
{
    ...
    private static WxPayAppConfig INSTANCE;
    ...
    public static WxPayAppConfig getInstance() throws Exception {
        if (INSTANCE == null) {
            synchronized (WxPayAppConfig.class) {
                if (INSTANCE == null) {
                    INSTANCE = new WxPayAppConfig();
                }
            }
        }
        return  INSTANCE;
